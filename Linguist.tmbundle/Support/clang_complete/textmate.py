...
def current_word(pat=r"[A-Za-z_]*", direction="both"):
  """ Return the current word from the environment. 
      pat - Regex for matching a word. Typically something like this: r"[A-Za-z_]*".
      direction - One of "both", "left", "right". Function will look in those directions for words.
  """
  word = ""
